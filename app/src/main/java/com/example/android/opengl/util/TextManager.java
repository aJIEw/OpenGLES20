...
public class TextManager {
    ...
    public void draw(float[] m) {
        ...
        int positionHandle = GLES20.glGetAttribLocation(GraphicTools.sp_Text, "vPosition");
        ...
        int texCoordHandle = GLES20.glGetAttribLocation(GraphicTools.sp_Text, "a_texCoord");
        ...
        int colorHandle = GLES20.glGetAttribLocation(GraphicTools.sp_Text, "a_Color");
        ...
        int mvpMatrixHandle = GLES20.glGetUniformLocation(GraphicTools.sp_Text, "uMVPMatrix");

        // Apply the projection and view transformation
        GLES20.glUniformMatrix4fv(mvpMatrixHandle, 1, false, m, 0);

        int sampleTextureHandle = GLES20.glGetUniformLocation(GraphicTools.sp_Text, "s_texture");

        // Set the sampler texture unit to our selected id
        GLES20.glUniform1i(sampleTextureHandle, texturenr);
