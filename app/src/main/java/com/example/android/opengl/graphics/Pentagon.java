...
public class Pentagon {
    ...
    private static float pentagonCoords[] = {
            -0.6f, 0.2f, 0.0f,   // 0:top left
            -0.4f, -0.5f, 0.0f,  // 1:bottom left
            0.4f, -0.5f, 0.0f,   // 2:bottom right
            0.6f, 0.2f, 0.0f,    // 3:top right
            0.0f, 0.6f, 0.0f,    // 4:top
    };
